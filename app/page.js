...
export default function Home() {
  ...
  return (
    ...
    <div className={styles.Hero}>
       ...
       <Image src="/logo/jankboxwhite.svg" alt="Jank Box Logo" width={200} height={200} />
       ...
       <div className={styles.navigateContainer}>
          <Link href='/addcardstocollection/search' className={styles.link} id={styles.search}>
            <div className={styles.option}>
              <h1>Advanced Search</h1>
              <h4>Browse for cards with advanced filters such as color, type, legality, and rarity</h4>
            </div>
          </Link>
          <Link href='/login' className={styles.link} id={styles.logIn}>
            <div className={styles.option}>
              <h1>Track Your Collection</h1>
              <h4>Log In Or Create An Account to start keeping track of your collection!</h4>
            </div>
          </Link>
